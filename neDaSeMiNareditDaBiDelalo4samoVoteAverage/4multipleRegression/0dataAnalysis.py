...
dfAllData = pd.read_csv('langCleanedData.csv')
...
Y = ['vote_average', 'vote_count']

X = dfAllData[['castFemalePercentage', 'crewFemalePercentage', 'runtime', 'releaseYear', 'releaseTimeOfYear']] 
dfAllData.head()
X = sm.add_constant(X) 
