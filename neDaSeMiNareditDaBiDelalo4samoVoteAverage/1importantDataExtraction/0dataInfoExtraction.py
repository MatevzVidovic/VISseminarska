...
# directorGender je bil sedaj dodan in bo tudi included
...
# !!!!!!!!!!!!!!!!!!!!!!!!
# PAZI KER OUTLIER REMOVER IMA HARDCODEAN BUDGET IN TO KOT IX=2. ZATO
# NOVE STOLPCE DODAJAJ DESNO OD TEGA
# !!!!!!!!!!!!!!!!!!!!!!!!
dfNewData = dfAllData[["castFemalePercentage", "crewFemalePercentage", "budget", "revenue", "revenueRatio",         "directorGender", "vote_average","vote_count",          "runtime",              "releaseYear", "releaseTimeOfYear", "original_language", "popularity",      "original_title", "title"]]
